...
class ConnectionPool extends BaseConnectionPool {
  _poolCreate () {
    return new shared.Promise((resolve, reject) => {
      ...
      this.config.requestTimeout = this.config.requestTimeout ?? this.config.timeout ?? 30000

      const cfg = {
        conn_str: this.config.connectionString || defaultConnectionString,
        conn_timeout: (this.config.connectionTimeout ?? this.config.timeout ?? 30000) / 1000
      }
